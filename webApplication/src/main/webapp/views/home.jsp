      ...
      <div class="container">
        ...
        <div class="section">
          ...
          <div class="actions">
            <div class="action">
              <span>Depositar</span>
              <button onclick="window.location.href='${pageContext.request.contextPath}/deposit'">Fazer
                Depósito</button>
            </div>
            <div class="action">
              <span>Sacar</span>
              <button onclick="window.location.href='${pageContext.request.contextPath}/withdraw'">Fazer
                Saque</button>
            </div>
            <div class="action">
              <span>Transferir</span>
              <button onclick="window.location.href='${pageContext.request.contextPath}/transfer'">Fazer
                Transferência</button>
            </div>
            <div class="action">
              <span>Investir</span>
              <button onclick="window.location.href='${pageContext.request.contextPath}/investment'">Fazer
                Investimento</button>
            </div>
          </div>
        </div>
